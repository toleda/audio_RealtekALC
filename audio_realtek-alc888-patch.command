...
# File: audio_realtek-alc888-patch.command
# Credit: d-an-w
#
...
#
# Installation
# 1. Downloads/audio_RealtekALC-master/audio_realtek-alc888-patch.command
# 2. Double click audio_realtek-alc888-patch.command
# 3. Enter password at prompt

echo " "
echo "Agreement"
echo "The audio_realtek-alc888-patch is for personal use only. Do not distribute"
...
echo "The audio_realtek-alc888-patch is provided as is and without any kind of"
echo “warranty.”
echo " "
