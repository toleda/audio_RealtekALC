...
# File: audio_realtek-alc885-patch.command
# Credit: d-an-w
#
# OS X Realtek ALC885 Onboard Audio
#
# Note: This patch is optional, native AppleHDA.kext supports ALC885 natively
#
...
#
# Installation
# 1. Downloads/audio_RealtekALC-master/audio_realtek-alc885-patch.command
# 2. Double click audio_realtek-alc885-patch.command
# 3. Enter password at prompt

echo " "
echo "Agreement"
echo "The audio_realtek-alc1150-patch is for personal use only. Do not distribute"
...
echo "The audio_realtek-alc1150-patch is provided as is and without any kind of"
echo “warranty.”
echo " "
