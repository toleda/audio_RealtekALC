...
# File: audio_realtek-alc1150-patch.command
# Credit: d-an-w
#
...
#
# Installation
# 1. Downloads/audio_RealtekALC-master/audio_realtek-alc1150-patch.command
# 2. Double click audio_realtek-alc1150-patch.command
